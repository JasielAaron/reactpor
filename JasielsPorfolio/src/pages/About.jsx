    ...
    return (
      <div className="container mb-5">
        ...
        <div className="card d-inline-flex p-2 container">
          ...
          <p className="card-tex">{aboutme.information}</p>
          <p  className= "card-tex" > I have been exposed to {aboutme.langugesused} and have been able to build full stack applications!</p>
          <p className="card-tex"> In my free time i enjoy {aboutme.hoobies}!</p>
